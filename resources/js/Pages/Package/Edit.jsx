...
export default function Create({ auth, services, packageData }) {
    const { data, setData, put, errors } = useForm({
        name: packageData.name || "",
        description: packageData.description || "",
        status: packageData.status || "",
        selectedServices: packageData.services || [],
        // selectedServices:packageData.services.map((service) => service.id) || [],

        Total_before_discount: packageData.Total_before_discount || 0,
        discount_value: packageData.discount_value || 0,
        Total_after_discount: packageData.Total_after_discount || 0,
        tax_rate: packageData.tax_rate || 0,
        Total_with_tax: packageData.Total_with_tax || 0,
        _method: "PUT",
    });
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        put(route("package.update", packageData.id));
    };
